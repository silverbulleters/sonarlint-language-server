...
class ServerConnectionSettingsTests {
  ...
  @Test
  void testToString() {
    assertThat(WITH_ORG).hasToString("ServerConnectionSettings[serverId=serverId,serverUrl=serverUrl,token=token,disableNotifications=false,organizationKey=myOrg]");
  }
