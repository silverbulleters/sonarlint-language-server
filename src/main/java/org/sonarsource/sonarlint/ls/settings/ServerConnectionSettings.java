...
public class ServerConnectionSettings {
  ...
  public ServerConnectionSettings(String serverId, String serverUrl, String token, @Nullable String organizationKey, boolean disableNotifications) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(serverId, serverUrl, token, organizationKey, disableNotifications);
  }
